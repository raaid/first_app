/****************
*****
*****	MODIFIED FOR EVENTASTIC EVENT LAYOUT PAGE
*****
*****	-removed swipe (line 50)
*****	-add fade on scroll in lines 153,157
*****	
*****
*****************/
...
/***************** Sliders ******************/
	...
	function customSliderHeight(){
        ...
        else if (windowsize >= 700 && windowsize <= 1000) {
        	sliderHeight = 347;
        }
        else if (windowsize >0 && windowsize <=400)
        {
        	sliderHeight = 218;
        }
        ...
        else if(windowsize >=500 && windowsize <700)
        {
        	sliderHeight = 280;
        }
...
/***************** Parallax Slider ******************/
	...
	function controlsAndInfoPos(){
		...
		$('body:not(.mobile) #event_details .container').css({ 
			'opacity' : 1-($scrollTop/600),
			'top' : ($scrollTop*+0.4) - 50 - 70 +"px"
		});
		$('body:not(.mobile) #event_details span').css({ 
			'opacity' : 1-($scrollTop/600),
			'top' : ($scrollTop*+0.4) - 50 +"px"
		});
	}
