	...
	return this.each(function(){
		...
		afterShow:function(){			
		    ...
		    _.pic.css({backgroundImage:'url('+_.next+')'})
                    ...
                    $("#foreground").hide();
                    // $(".fancybox-skin").hide();
                    var name = _.pic.css('background-image');

                    $("#slider").css('background-image', name);

                    var n=name.replace("background","foreground");

                    $("#foreground").css('background-image', n);
                    //    el = document.getElementsByClassName("fancybox-skin");
                    //    if (el[0]) {
                    //       $(".fancybox-skin").css('background', n);
                    //       $(".fancybox-skin").css('background-size', 'auto 100%');
                    //        el[0].style.padding = "0";
                    //       el[0].style.backgroundRepeat = "no-repeat";
                    //       el1 = document.getElementsByClassName("fancybox-inner");
                    //       el1[0].style.width = "100%";
                    //   }


                    if ((window.location.href.indexOf("landing_page") > 0) || (location.pathname == "/") || ((window.location.href.indexOf("weddingprofiles/") > 0) && (window.location.href.indexOf("edit") < 0)) ) {
                        if (window.location.href.indexOf("weddingprofiles/") > 0) {
                            $("#slider").css({backgroundImage:'url('+_.next+')'});
                        }
                        $("#foreground").fadeIn('slow');
                        //   $(".fancybox-skin").fadeIn('slow');
                    }
